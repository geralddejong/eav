...
/**
 * The value subclass for handling small strings
 *
 * @author Gerald de Jong, Beautiful Code BV, <geralddejong@gmail.com>
 */

@Entity
public class EAVString extends EAVValue {

    private static final int MAX_LENGTH = 160;

    @Column(length = MAX_LENGTH)
    @Index(name = "eavstringindex")
    private String value;

    public EAVString() {
    }

    public EAVString(EAVEntity entity, EAVPath path, Principal createdBy, String value) throws EAVPathException {
